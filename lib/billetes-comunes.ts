...
// Billetes del Euro
export const billetesEuro: Billete[] = [
  {
...
// Billetes del Franco CFA
export const billetesCFA: Billete[] = [
  {
    denominacion: '500 Francos CFA (África Occidental)',
    versiones: [
      { 
        anioEmision: '2003', 
  ...
  {
    denominacion: '1000 Francos CFA (África Occidental)',
    versiones: [
      { 
        anioEmision: '2003', 
  ...
  {
    denominacion: '2000 Francos CFA (África Occidental)',
    versiones: [
      { 
        anioEmision: '2003', 
  ...
  {
    denominacion: '5000 Francos CFA (África Occidental)',
    versiones: [
      { 
        anioEmision: '2003', 
  ...
  {
    denominacion: '10000 Francos CFA (África Occidental)',
    versiones: [
      { 
        anioEmision: '2003', 
