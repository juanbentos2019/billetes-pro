...
export const billetesEuropa: Record<string, Billete[]> = {
  ...
  "Bosnia": [
  {
    denominacion: '10 Marcos Convertibles',
    versiones: [
      {
  ...
  {
    denominacion: '20 Marcos Convertibles',
    versiones: [
      {
        anioEmision: '2012 - Federación de BiH',
  ...
  {
    denominacion: '50 Marcos Convertibles',
    versiones: [
      {
        anioEmision: '2012 - Federación de BiH',
  ...
  {
    denominacion: '100 Marcos Convertibles',
    versiones: [
      {
        anioEmision: '2012 - Federación de BiH',
  ...
  {
    denominacion: '200 Marcos Convertibles',
    versiones: [
      {
        anioEmision: '2012',
